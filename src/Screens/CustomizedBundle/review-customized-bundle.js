...
export default function ReviewCustomizedBundle({ navigation }) {
    ...
    return (
        <>
            ...
            <View
                ...
                <AppButton
                    preset="primary"
                    text={`${Constants.Laungagues.add_to_cart == null ? 'Add to cart' : Constants.Laungagues.add_to_cart}: ${105.00} ${Constants.Laungagues.aed == null ? 'AED' : Constants.Laungagues.aed}`}
                    style={{ marginTop: Metrics.rfv(16) }}
                    onPress={() => navigation.navigate('CustomizedBundleBox')}
                />
            </View>
        </>
    );
